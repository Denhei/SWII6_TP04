...
namespace Tp04.WebApi.Controllers
{
  ...
  {
    private readonly Tp04Context _tp04Context;

    public LivroController(Tp04Context tp04Context)
    {
    ...
    {
      // Livro ultimoLivro = _tp04Context.Livros.OrderByDescending(x => x.Id).FirstOrDefault();
